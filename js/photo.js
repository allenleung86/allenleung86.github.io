        ...
        render: function (page, data) {
            ...
            for (var i = begin; i < end && i < data.length; i++) {
                li += '<li><div class="img-box">' +
                    '<a class="img-bg" rel="example_group" href="https://github.com/allenl33eung86/allenleung86.github.io/tree/hexoSrc/photos/' + data[i] + '?raw=true"></a>' +
                    '<img lazy-src="https://github.com/allen33leung86/allenleung86.github.io/tree/hexoSrc/photos/' + data[i] + '?raw=true" />' +
                    '</li>';
            }
